...
{
    JUMP,DOUBLEJUMP, DASH, SLASH,WALK,TAKE_DAMAGE, LANDED,MAIN_MUSIC, PAUSE_MUSIC, START_MUSIC, BOSS_MUSIC, BOLTS, CHARGER_WALK, CHARGER_DIE_,CHARGER_BLOCK, CHARGER_HIT, TURRET_DIE, TURRET_SHOOT
}
